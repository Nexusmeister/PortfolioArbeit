    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <form method="post" action="../php/BestellungAnlegen.php">
                    <div class="form-group ">
                        <label class="control-label requiredField" for="artikelBez">
                            Artikelbezeichnung
                            <span class="asteriskField">*</span>
                        </label>
                        <select class="select form-control" id="artikelBez" name="artikelBez">
                    ...
                    <div class="form-group ">
                        ...
                        <input class="form-control" id="vpe" name="vpe" placeholder="z.B. 50" type="text"/>
                    </div>
                    <!--
                    <div class="form-group ">
                        <label class="control-label requiredField" for="bestellmenge">
                            Menge / VPE
                            <span class="asteriskField">*</span>
                        </label>
                        <input class="form-control" id="bestellmenge" name="bestellmenge" placeholder="individuell für Artikel machen?" type="text" readonly/>
                    </div>
                    -->
                    <div class="form-group ">
                        ...
                        <input class="form-control" id="datum" name="datum" placeholder="YYYY-MM-DD" type="text"/>
                    </div>
                    <div class="form-group">
                        <div>
                            <button class="btn btn-danger " name="submit" type="submit">Bestellung senden</button>
                        </div>
                    </div>
                </form>
            </div>
